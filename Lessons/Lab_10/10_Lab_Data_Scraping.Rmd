...
#change URL to have updated flow gage number and day range
theURL <- 
...
#Load in data using the package's "readNWISdv" function where NWIS is server ID?
...
```{r}
#Apply the API key
#keys are used to access data for cyber security reasons, typically available on website
census_api_key("d4ad7874c996c7a83fec0a81466309ddc07d8e22a", install = TRUE)

#need to look up variable names online
nc_pop <- 
...
EIA.Data <- data.frame(state = the_states, 
                       price = the_price)

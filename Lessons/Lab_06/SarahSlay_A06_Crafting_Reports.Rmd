...
```{r project.setup, echo=FALSE, warning=FALSE, message= FALSE}
#Import libraries
library(tidyverse)
library(lubridate)
library(here)
...
```{r, fig.align='left', fig.height=3, fig.width=5, echo= FALSE, fig.cap="2019 Ozone Levels by Month"}
#Create a boxplot for 2019 ozone levels by month
Box.2019 <- epa_data %>%
  filter(Year == 2019) %>%
  ggplot(aes(x = factor(Month), y = Ozone)) +
  geom_boxplot()
...
## Git Repository
https://github.com/sslay17/EDE_Fall2025

I did not use AI in the completion of this assignment followed by your name and the date - Sarah Slay

...
# Multiplies vector1 and vector4
vector1 * vector4

# Multiplies vector1 by 10
vector1 * 10

# Returns the string values in upper case
toupper(vector2) 

# Inverts the boolean values in vector 3
!vector3
...
matrix1[4,  ] # Returns all the values in row 4

matrix1[ , 3] # Returns all the values in column 3

matrix1[c(12, 14)] # Given a vector, returns 12th and 14th item

matrix1[c(12:14)] # Given a vector, returns 12th thru 14th items

matrix1[2:4, 1:3] # Returns values in 2nd thru 4th rows and 1st thru 3rd columns.  
...
# Show list item names
names(list1)

# Show items 1 thru 2 on list
list1[1:2]

# Change list name to Janelle
list1$name = "Janelle"

# Changes 4th item in list to 44
list1[[4]] = 44
```
...
# Data Frames ---- Combining multiple vectors or lists
